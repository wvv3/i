{
    ...
    "图片是否需要代理": "1",
    "是否开启获取首页数据": "1",
    "首页推荐链接": "https://qkan8.com",
    "首页列表数组规则": "body&&.fed-list-info:has(.fed-list-remarks)",
    "首页片单列表数组规则": "li",
    "首页片单是否Jsoup写法": "1",
    "分类起始页码": "1",
    "分类链接": "https://qkan8.com/index.php/vod/type/id/{cateId}/page/{catePg}.html",
    "分类名称": "日漫&国漫",
    "分类名称替换词": "21&20",
    //"分类名称替换词": "1&2&3&4",
    "筛选数据": {},
    ...
    "分类片单链接加前缀": "https://qkan8.com",
    "分类片单链接加后缀": "",
    "搜索请求头参数": "手机",
    "搜索链接": "https://qkan8.com/index.php/ajax/suggest.html?mid=1&wd={wd}",
    "POST请求数据": "",
    "搜索截取模式": "0",
    "搜索列表数组规则": "list",
    "搜索片单是否Jsoup写法": "1",
    ...
    "搜索片单链接": "id",
    "搜索片单副标题": "",
    "搜索片单链接加前缀": "https://qkan8.com/index.php/vod/detail/id/",
    "搜索片单链接加后缀": ".html",
    "链接是否直接播放": "0",
    "直接播放链接加前缀": "",
    "直接播放链接加后缀": "",
